...
function Logo({ variant = "inline" }) {
  return (
    <div className={`brand-logo ${variant}`}>
      <svg viewBox="0 0 160 58" role="img" aria-label="MoneyPlus">
        <defs>
        ...
        <text x="68" y="27" fontSize="17" fontWeight="700" fill="#2b2b34">
          Money
        </text>
        <text x="114" y="27" fontSize="17" fontWeight="700" fill="#ff572f">
          Plus
        </text>
        <text x="68" y="44" fontSize="8" letterSpacing="4" fill="#8a8694">
          ASSOCIATE
        </text>
      </svg>
    </div>
